...
== Description ==
This plugin makes long and complex navigation menus better manageable by creating groups that can be expanded and collapsed. It does not actually add any new features but simply is an enhancement to the user interface.
